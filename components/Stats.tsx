        ...
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-10">
          <ScrollReveal className="lg:col-span-5">
            ...
            <h2 className="font-display text-4xl sm:text-5xl md:text-6xl text-ink leading-[1.02] tracking-tightest">
              Логистика без<br />
              <span className="italic text-brand-500">«авось доедет».</span>
            </h2>
            ...
            {stats.map((s) => (
              <div key={s.label} className="bg-cream p-6 sm:p-8 md:p-10">
                <div className="flex items-baseline gap-2 mb-3 md:mb-4">
                  <span className="font-display text-4xl sm:text-5xl md:text-6xl text-ink leading-none tracking-tightest whitespace-nowrap">
                    {s.value}
                  </span>
                  <span className="font-mono text-xs sm:text-sm text-brand-500 uppercase tracking-widest">
                    {s.unit}
                  </span>
                </div>
