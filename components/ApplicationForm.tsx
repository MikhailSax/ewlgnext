...
export default function ApplicationForm() {
  ...
  return (
    <section id="contact" className="py-20 md:py-32 bg-cream border-t border-ink/8 relative overflow-hidden">
      ...
      <div className="absolute -bottom-10 sm:-bottom-20 -right-5 sm:-right-10 font-display text-[10rem] sm:text-[16rem] md:text-[22rem] leading-none text-ink/[0.025] select-none pointer-events-none tracking-tightest">
        ewlg
      </div>
      ...
      <div className="max-w-8xl mx-auto px-5 md:px-10 relative">
        <div className="grid lg:grid-cols-12 gap-10 lg:gap-12">
          ...
          <ScrollReveal delay={150} className="lg:col-span-6 lg:col-start-7">
            ...
            >
              <div className="absolute top-4 right-4 font-mono text-[10px] tracking-widest text-cream/40 uppercase">
                EWLG · FORM
              </div>
              ...
              {status === "success" ? (
                ...
                <>
                  <div className="font-mono text-[10px] tracking-widest text-brand-400 uppercase mb-6 md:mb-8">
                    Новая заявка
                  </div>
                  ...
                  {status === "error" && errorMsg && (
                    <div className="mt-5 md:mt-6 px-4 py-3 border-l-2 border-brand-400 text-sm text-cream/90 bg-cream/[0.04] animate-fadeIn">
                      {errorMsg}
                    </div>
                  )}
                  ...
                  <button
                    ...
                    className="group mt-8 md:mt-10 w-full inline-flex items-center justify-between px-5 sm:px-6 py-4 sm:py-5 bg-brand-500 hover:bg-brand-600 disabled:bg-brand-500/60 text-cream transition-colors duration-300"
                  >
                  ...
                  <p className="mt-5 md:mt-6 text-xs text-cream/40 leading-relaxed">
                    Отправляя форму, вы соглашаетесь на обработку персональных
                    данных. Мы не передаём контакты третьим лицам.
                  </p>
                </>
              )}
            </form>
