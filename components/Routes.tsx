...
function RouteCard({
  ...
  if (featured) {
    return (
      <div className="bg-cream p-7 sm:p-10 md:p-12 group hover:bg-jade-50 transition-all duration-500 cursor-default relative overflow-hidden">
        {/* Large CN watermark */}
        <div className="absolute -bottom-8 -right-2 font-display text-[12rem] sm:text-[18rem] leading-none text-ink/[0.03] select-none pointer-events-none tracking-tightest">
          {code}
        </div>
        ...
        <div className="relative grid lg:grid-cols-12 gap-8 lg:gap-10 items-start">
          <div className="lg:col-span-5">
            <div className="flex items-start justify-between mb-5 md:mb-6">
              ...
              <div className="inline-flex items-center gap-2 font-mono text-xs tracking-widest text-brand-500 uppercase">
